...
class GaussianMixOutputModel(OutputModel):
    """
    HMM output probability model using Gaussian mixtures
    ...
    def __repr__(self):
        ...
        >>> output_model = GaussianMixOutputModel(nstates=3, means=[-1, 0, 1], sigmas=[0.5, 1, 2])
