...
def init_model_gaussian_mix(observations, nstates, mcomponents, reversible=True):
    #ToDo automate gaussian mixture output model
    """Generate an initial model with 1D-Guassian mixture output densities
    ...
    >>> [model, observations, states] = testsystems.generate_synthetic_observations(output='gaussian mixture')
    >>> initial_model = init_model_gaussian1d(observations, model.nstates, model.mcomponents)
